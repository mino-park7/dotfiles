...
- The skill reads `.claude/skills/pr-open/PR_TEMPLATE.md` as the template structure — if the template is updated, the skill automatically follows the new format
